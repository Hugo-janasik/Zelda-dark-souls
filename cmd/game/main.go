...
func main() {
	...
	fmt.Println("• assets/textures/player/up_idle - Animation idle vers le haut")
	fmt.Println("• assets/textures/player/up_attack - Animation attaque vers le haut")
	fmt.Println("• assets/textures/player/down_idle - Animation idle vers le bas")
	fmt.Println("• assets/textures/player/down_attack - Animation attaque vers le bas")
	fmt.Println("• assets/textures/player/left_idle - Animation idle vers la gauche")
	fmt.Println("• assets/textures/player/left_attack - Animation attaque vers la gauche")
	fmt.Println("• assets/textures/player/right_idle - Animation idle vers la droite")
	fmt.Println("• assets/textures/player/right_attack - Animation attaque vers la droite")
	fmt.Println("")
